"""Explode SocialWorkers.documents into sqlmesh_work.btxh_stg_social_worker_documents."""
...
from .btxh_helper import explode_social_worker_documents
...
@model(
    "sqlmesh_work.btxh_stg_social_worker_documents",
    description=(
        "Exploded BTXH social worker documents from public.\"SocialWorkers\" "
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            while True:
                ...
                for row in rows:
                    records.extend(explode_social_worker_documents(dict(row)))
